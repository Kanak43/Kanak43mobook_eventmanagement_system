            ...
            <div class="col-md-2">
                <div class="text-container">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        <li>
                            <a class="white" href="#your-link">abc.com</a>
                        </li>
                        <li>
                           <a class="white" href="#your-link">abc.com</a>
                        </li>
                        <li class="media">
                            <a class="white" href="#your-link">abc.net</a>
                        </li>
                    </ul>
                </div> <!-- end of text-container -->
            </div> <!-- end of col -->
            <div class="col-md-2">
                <div class="text-container">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li>
                            <a class="white" href="#your-link">abc.gov</a>
                        </li>
                    </ul>
                </div> <!-- end of text-container -->
            </div> <!-- end of col -->
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <p class="p-small">Copyright © 2022 <a href="#">Template by Mobook</a></p>
            </div> <!-- end of col -->
        </div> <!-- enf of row -->
    </div> <!-- end of container -->
