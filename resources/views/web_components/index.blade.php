            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <div class="testimonial-author">Sakib - CEO</div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card">
                                            <div class="card-image">
                                                <img style="height:195px; width: 395px; " class="img-fluid" src="{{asset('public/media/'.$data->image)}}" alt="alternative">
                                            </div>
                                            <div class="card-body">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="address"><i class="fas fa-map-marker-alt"></i>Dhanmondi, Dhaka-1209</li>
                            <li><i class="fas fa-phone"></i><a href="tel:003024630820">+880178888888</a></li>
                            <li><i class="fas fa-phone"></i><a href="tel:003024630820">+880189888999</a></li>
                            <li><i class="fas fa-envelope"></i><a href="mailto:office@mobook.com">office@mobook.com</a></li>
                        </ul>
